    ...
    <div class="col-12">
        <div class="card p-4 shadow-sm">
            ...
            <div class="table-responsive">
                <table id="borrowTable" class="table table-striped table-hover table-sm align-middle w-100 small">
...
<div class="row g-4">
    <div class="col-12">
        <div class="card p-4 shadow-sm">
            ...
            <div class="table-responsive">
                <table id="inventoryTable" class="table table-striped table-hover table-sm align-middle w-100 small">
                    <thead class="table-light">
                        <tr>
                            <th>สินค้า</th>
